  ...
  useEffect(() => {
    getCandidateReferrals()
      ...
      .catch((requestError) => {
        ...
        setError('Unable to load your referral history.')
      })
        ...
        <div className="mx-auto max-w-7xl space-y-8">
          <section className="rounded-[2rem] border border-white/80 bg-white/90 p-7 shadow-[0_20px_60px_rgba(15,23,42,0.10)] backdrop-blur sm:p-8">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
              Your referral timeline
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
              See where you have been referred and track the latest updates.
            </p>
          </section>
          ...
          {!loading && !error && referrals.length === 0 && (
            <section className="rounded-[2rem] border border-dashed border-slate-300 bg-white/90 p-10 text-center shadow-sm">
              ...
              <p className="mt-3 text-sm text-slate-600">Referral updates will appear here once your profile is referred.</p>
            </section>
          )}
