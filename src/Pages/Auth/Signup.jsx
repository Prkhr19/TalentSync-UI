          ...
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <section className="max-w-xl">
              ...
              <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
                Set up your account once, then move through applications and recruiter workflows in a calm,
                organized space.
              </p>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur">
                  <p className="text-sm font-medium text-slate-500">Recruiter setup</p>
                  <p className="mt-2 text-sm leading-6 text-slate-700">Post roles and manage applicants in one place.</p>
                </div>
              </div>
            </section>
              ...
              <div className="rounded-[2rem] border border-white/80 bg-white/90 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur sm:p-8">
                <div className="border-b border-slate-200 pb-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Fill in your details to create your HireHub account.
                  </p>
                </div>
                ...
                <form onSubmit={submitHandler} className="mt-6 space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-sky-100"
                    >
